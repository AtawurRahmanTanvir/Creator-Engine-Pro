    ...
    while (true) { 
        switch (currentState) {
            ...
            case State.OUTPUT_COPIED: 
                console.log(`[STATE] 📋 ${currentState}: Extracting full multi-paragraph text from DOM...`);
